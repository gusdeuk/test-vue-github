...
import classesScoped from './MuiAccordion.module.scss'
...
function MuiAccordion() {
    ...
    /* return (
        <div className={classesScoped.menusComponent}>


            <div className={classes.contentRow}>

                <div className={classes.contentCol1}>
                    <div className={classes.subtitle}>asdasdasdasd
                    </div>
