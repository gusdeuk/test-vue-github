...
const routes = [
    ...
    },
    {
        ...
        // -----------------------------------------------------------------
        component: () => {
            return import(/* webpackChunkName: "page-starships" */ '../views/StarshipsPage/StarshipsPage.vue');
        }
    },
    {
        path: '/contact',
        name: 'Contact',
        component: () => {
            return import(/* webpackChunkName: "page-contact" */ '../views/ContactPage/ContactPage.vue');
        }
    },
    {
        path: '/shop',
